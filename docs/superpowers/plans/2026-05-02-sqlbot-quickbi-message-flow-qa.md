...
- Original Case 3 HAR capture was unreliable because it saved with 0 entries; final Case 3 evidence files were replaced with the clean repro predict request and user-visible prediction screenshot instead of relying on the failing `data-testid` locator.
