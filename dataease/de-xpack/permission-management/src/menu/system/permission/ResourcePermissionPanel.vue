...
import type { PermissionColumnKey, PermissionResourceFlag, PermissionSubjectType } from './types'
        ...
        <section class="panel">
          <div v-if="shell.mode.value === 'by-user'" class="panel__body panel__body--user">
            ...
            <div class="table-panel">
              <div class="toolbar-row">
                <div class="search-box search-box--wide"><span>⌕</span><span>搜索名称</span></div>
                <button
                  type="button"
                  class="save-btn"
          ...
          <div v-else class="panel__body panel__body--resource">
            ...
            <div class="resource-panel">
              <div class="search-box search-box--small"><span>⌕</span><span>搜索名称</span></div>
