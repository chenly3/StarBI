export default {
  common: {
    ...
    next_quarter: '下季',
    next_year: '明年',
    sqlbot_settings: 'StarBI AI 設定',
    sqlbot_old_settings: '智能問數OLD 設定',
    third_party_embed: '第三方嵌入',
    application_id: '應用程式 ID',
    sqlbot_server_url: 'StarBI AI 服務 URL',
  ...
  starbi: {
    brand_name: 'StarBI',
    smart_query_title: '智能問數',
    smart_query_old_title: '智能問數OLD',
    smart_query_subtitle: '在 StarBI 中選擇分析主題與資料集範圍，發起統一智能問數。',
    from_dashboard: '來自儀表板',
    dashboard_context_desc: '目前會話已自動帶入儀表板上下文與篩選條件。',
    view_filter_snapshot: '查看篩選快照',
    select_theme: '選擇分析主題',
    select_theme_placeholder: '請選擇分析主題',
    select_datasets: '選擇資料集範圍',
    select_datasets_placeholder: '請選擇資料集',
    select_datasource: '選擇執行資料來源',
    select_datasource_placeholder: '請選擇資料來源',
    datasource_scope_hint: '目前主題資料集涉及多個資料來源，請選擇本次會話使用的資料來源。',
    active_theme: '目前主題',
    theme_not_selected: '未選擇主題',
    dataset_scope_count: '資料集數量',
    current_datasource: '目前資料來源',
    datasource_not_selected: '未選擇資料來源',
    auto_match: '自動匹配',
    selected_dataset_scope: '已選資料集範圍',
    scope_dataset_progress: '已選 {0} / {1} 個資料集',
    select_all_theme_datasets: '全選主題資料集',
    no_dataset_selected: '目前未選擇任何資料集',
    theme_description: '主題說明',
    recommended_questions: '推薦問題',
    filter_count: '已帶入 {0} 個篩選條件',
    scope_will_restart: '主題或資料集範圍已變更，開始問數後將自動建立新會話。',
    default_query_desc: '在限定的資料集範圍內發起問數，會話將保持目前主題快照。',
    reset_scope: '重置範圍',
    restart_query: '重新問數',
    start_query: '開始問數',
    query_unavailable: 'StarBI 智能問數暫時無法使用',
    query_unavailable_desc: '請先在系統參數中完成 StarBI 服務接入並通過校驗。',
    query_empty_title: '選擇分析主題後開始問數',
    query_empty_desc: '先選擇主題與資料集範圍，再進入 StarBI 智能問數會話。',
    default_query_welcome: '你好，我是 StarBI 智能分析助手',
    dashboard_query_welcome: '我已帶入目前儀表板上下文，可以圍繞目前分析場景繼續問數。',
    query_scope_invalid: '請先選擇分析主題、資料集範圍，並在需要時選擇資料來源',
    query_theme_title: '分析主題',
    query_theme_subtitle: '依業務場景組織資料集，作為 StarBI 智能問數的統一範圍入口。',
    new_query_theme: '新建分析主題',
    theme_dataset_count: '資料集數',
    enabled: '啟用',
    disabled: '停用',
    no_query_theme: '暫無分析主題',
    query_theme_empty_title: '目前還沒有可用的分析主題',
    query_theme_empty_desc:
      '請先在資料準備中建立至少一個分析主題，並綁定可存取的資料集後，再返回 StarBI 智能問數頁開始會話。',
    go_create_query_theme: '去建立分析主題',
    refresh_query_theme_list: '刷新主題列表',
    edit_query_theme: '編輯分析主題',
    sort_order: '排序',
    query_theme_description_placeholder: '請輸入主題描述，幫助使用者理解適用場景',
    theme_datasets: '主題資料集',
    select_theme_datasets: '請選擇主題資料集',
    default_datasets: '預設資料集',
    default_datasets_placeholder: '請選擇預設資料集',
    welcome_text: '歡迎文案',
    welcome_text_placeholder: '請輸入進入問數頁時的歡迎提示',
    recommended_questions_placeholder: '每行一個推薦問題',
    default_dashboard_id: '預設儀表板 ID',
    default_dashboard_id_placeholder: '選填，用於儀表板問數預設綁定',
    delete_theme_confirm: '確認刪除分析主題「{name}」嗎？',
    ai_model_config: 'AI 模型設定',
    ai_model_config_desc: '統一管理 StarBI 智能問數使用的模型與預設能力。',
    term_config: '術語設定',
    term_config_desc: '維護業務術語與同義詞，提升 StarBI 問數理解能力。',
    sql_example_config: 'SQL 範例庫',
    sql_example_config_desc: '維護高品質 SQL 範例，增強 Text-to-SQL 生成效果。',
    ai_config_group: '通用設定',
    ai_config_center: 'AI 設定中心',
    ai_config_center_desc: '統一維護模型、術語與 SQL 範例庫，作為智能問數的通用設定入口。',
    query_config_title: '問數設定',
    query_config_subtitle: '統一管理問數資源與分析主題，作為系統設定下的智能問數設定入口。',
    query_config_resource_manage: '問數資源管理',
    query_config_theme_manage: '分析主題管理',
    ai_config_current_module: '目前模組',
    ai_config_quick_entry: '快捷入口',
    ai_config_related_settings: '相關系統能力',
    ai_config_nav_title: '設定分組',
    ai_config_nav_desc: '同組設定在頁面內切換，保持系統導覽穩定、層級清晰。',
    ai_config_current_badge: '目前',
    ai_config_switch_badge: '切換',
    ai_config_embed_title: '嵌入式 AI 設定',
    ai_config_hosted_tip: '目前頁面由 StarBI 系統管理承載，設定內容以內嵌 AI 模組方式提供。',
    ai_config_org_scope_tip: '設定會跟隨目前組織切換，並持續受管理員權限控制。',
    ai_embed_unavailable: 'AI 設定頁面暫時無法使用',
    ai_embed_connecting: '連線中',
    ai_embed_ready: '已連線',
    ai_embed_timeout: '連線逾時',
    ai_embed_timeout_desc: 'AI 設定頁面未在預期時間內完成載入，請刷新頁面或重試連線。',
    ai_embed_loading_desc: '正在驗證存取令牌並初始化嵌入頁面，請稍候。',
    ai_embed_refresh: '刷新頁面',
    ai_embed_retry: '重試連線',
    ai_embed_hosted_by_starbi: '由 StarBI 系統管理承載',
    ai_embed_service_domain: 'AI 服務：',
    ai_embed_last_ready: '最近同步：{0}',
    check_starbi_connection: '請檢查 StarBI AI 服務接入設定、令牌與網路連通性',
    dashboard_query_entry: '問數',
    sqlbot_secret_placeholder: '請輸入 StarBI Secret'
  },
  toolbox: {
    name: '工具箱',
  ...
  visualization: {
    ...
    app_name: '應用名稱',
    app_version: '應用版本號',
    app_required_version: 'StarBI最低版本號',
    description: '描述',
    new_dataset: '新建數據集',
  ...
  userCenter: {
    ...
    api_key_desc:
      'API Key 是您存取 StarBI API 的金鑰，具有帳戶的完全權限，請務必妥善保管！不要以任何方式公開 API Key 到外部頻道，避免被他人利用造成安全威脅。 '
  },
  free: {
    title: '遊離資源管理',
    no_data: '暫無遊離資源',
