export default {
  common: {
    ...
    next_quarter: '下季',
    next_year: '明年',
    sqlbot_settings: 'StarBI AI 设置',
    sqlbot_old_settings: '智能问数OLD 设置',
    third_party_embed: '第三方嵌入',
    application_id: '应用 ID',
    sqlbot_server_url: 'StarBI AI 服务 URL',
    sqlbot_secret: 'StarBI Secret',
  ...
  starbi: {
    brand_name: 'StarBI',
    smart_query_title: '智能问数',
    smart_query_new_title: '智能问数new',
    smart_query_old_title: '智能问数OLD',
    smart_query_subtitle: '像使用 Quick BI 小Q 一样，选择数据集或数据文件后直接发起智能问数。',
    smart_query_scope_dataset: '数据集问数',
    smart_query_scope_file: '数据文件问数',
    smart_query_scope_dataset_desc: '围绕一个或多个数据集进行问答、分析和图表生成。',
    smart_query_scope_file_desc: '围绕 Excel/CSV 数据文件进行问答与分析。',
    smart_query_current_selection: '当前选择',
    smart_query_scope_label: '当前问数范围',
    smart_query_open_selector: '选择数据对象',
    smart_query_change_scope: '重新选择',
    smart_query_selector_title: '选择问数对象',
    smart_query_selector_reset: '清空选择',
    smart_query_selector_apply: '完成选择',
    smart_query_search_placeholder: '输入名称搜索',
    smart_query_dataset_drawer_desc: '可多选数据集，当前会话只会在所选数据集范围内进行问数。',
    smart_query_file_drawer_desc:
      '请选择一个本地或远程 Excel/CSV 数据文件数据源，当前会话会以该文件数据为分析范围。',
    smart_query_no_dataset_selected: '还没有选择数据集',
    smart_query_no_file_selected: '还没有选择数据文件',
    smart_query_selected_dataset_count: '已选择 {0} 个数据集',
    smart_query_dataset_meta_empty: '先选择数据集，再开始 StarBI 智能问数。',
    smart_query_file_meta_empty: '先选择数据文件，再开始 StarBI 智能问数。',
    smart_query_scope_locked: '当前会话只会作用于你已经选择的数据对象。',
    smart_query_datasource_hint: '所选数据集涉及多个数据源，请补充选择本次会话使用的数据源。',
    smart_query_dataset_hint: '建议先明确分析对象，再输入问题，结果会更稳定。',
    smart_query_file_hint: '文件问数会围绕当前选中的 Excel/CSV 文件数据源进行分析。',
    smart_query_ask_placeholder_dataset: '例如：近30天销售额趋势如何？帮我画一个趋势图。',
    smart_query_ask_placeholder_file: '例如：这份文件里各区域销售额排名如何？生成一个柱状图。',
    smart_query_recommended_title: '不妨试试这些问题',
    smart_query_example_dataset_1: '最近30天销售额趋势如何？',
    smart_query_example_dataset_2: '按地区统计本月订单金额，并生成柱状图',
    smart_query_example_dataset_3: '找出同比下降最多的三个产品类别',
    smart_query_example_dataset_4: '帮我总结一下本季度的核心异常指标',
    smart_query_example_file_1: '这份文件里有哪些关键指标值得关注？',
    smart_query_example_file_2: '按区域汇总销售额并生成可视化图表',
    smart_query_example_file_3: '找出数据里增长最快的客户群',
    smart_query_example_file_4: '概括一下这份文件里的主要业务结论',
    smart_query_usage_title: '使用建议',
    smart_query_usage_item_1: '先锁定数据集或文件，再问具体指标、时间范围和维度。',
    smart_query_usage_item_2: '优先用业务语言提问，StarBI 会自动补全 SQL 与图表建议。',
    smart_query_usage_item_3: '切换数据对象后会开启新会话，避免不同数据上下文串扰。',
    smart_query_empty_title: '先选择数据集或数据文件',
    smart_query_empty_desc: '问数入口只作用于数据集和文件，选定对象后即可进入会话。',
    smart_query_ready_desc: '范围已经准备好，你可以直接输入问题，或先进入空白会话再继续追问。',
    smart_query_upload_file: '去上传文件',
    smart_query_manage_dataset: '前往数据准备',
    smart_query_root_path: '根目录',
    smart_query_no_dataset_available: '暂无可用数据集',
    smart_query_no_file_available: '暂无可用数据文件',
    smart_query_dataset_leaf: '数据集',
    smart_query_select_data_first: '请先选择数据集或数据文件',
    from_dashboard: '来自仪表盘',
    dashboard_context_desc: '当前会话已自动带入仪表盘上下文与筛选条件。',
    view_filter_snapshot: '查看筛选快照',
    select_theme: '选择分析主题',
    select_theme_placeholder: '请选择分析主题',
    select_datasets: '选择数据集范围',
    select_datasets_placeholder: '请选择数据集',
    select_datasource: '选择执行数据源',
    select_datasource_placeholder: '请选择数据源',
    datasource_scope_hint: '当前主题数据集涉及多个数据源，请选择本次会话使用的数据源。',
    active_theme: '当前主题',
    theme_not_selected: '未选择主题',
    dataset_scope_count: '数据集数量',
    current_datasource: '当前数据源',
    datasource_not_selected: '未选择数据源',
    auto_match: '自动匹配',
    selected_dataset_scope: '已选数据集范围',
    scope_dataset_progress: '已选 {0} / {1} 个数据集',
    select_all_theme_datasets: '全选主题数据集',
    no_dataset_selected: '当前未选择任何数据集',
    theme_description: '主题说明',
    recommended_questions: '推荐问题',
    filter_count: '已带入 {0} 个筛选条件',
    scope_will_restart: '主题或数据集范围已变化，开始问数后将自动创建新会话。',
    default_query_desc: '在当前选择的数据对象范围内发起问数，会话将保持当前范围上下文。',
    reset_scope: '重置范围',
    restart_query: '重新问数',
    start_query: '开始问数',
    query_unavailable: 'StarBI 智能问数暂不可用',
    query_unavailable_desc: '请先在系统参数中完成 StarBI 服务接入并通过校验。',
    query_empty_title: '选择数据集或数据文件后开始问数',
    query_empty_desc: '先选择数据对象，再进入 StarBI 智能问数会话。',
    default_query_welcome: '你好，我是 StarBI 智能分析助手',
    smart_query_file_welcome: '你好，我是 StarBI 文件分析助手',
    smart_query_dataset_welcome_desc: '我会围绕当前选择的数据集回答问题，并生成图表建议。',
    smart_query_file_welcome_desc: '我会围绕当前文件数据回答问题，并生成图表建议。',
    dashboard_query_welcome: '我已带入当前仪表盘上下文，可以围绕当前分析场景继续问数。',
    query_scope_invalid: '请先选择数据集或数据文件，并在需要时选择数据源',
    query_theme_title: '分析主题',
    query_theme_subtitle: '按业务场景组织数据集，作为 StarBI 智能问数的统一范围入口。',
    new_query_theme: '新建分析主题',
    theme_dataset_count: '数据集数',
    enabled: '启用',
    disabled: '停用',
    no_query_theme: '暂无分析主题',
    query_theme_empty_title: '还没有可用的分析主题',
    query_theme_empty_desc:
      '请先在数据准备中创建至少一个分析主题，并绑定可访问的数据集后，再返回 StarBI 智能问数页开始会话。',
    go_create_query_theme: '去创建分析主题',
    refresh_query_theme_list: '刷新主题列表',
    edit_query_theme: '编辑分析主题',
    sort_order: '排序',
    query_theme_description_placeholder: '请输入主题描述，帮助用户理解适用场景',
    theme_datasets: '主题数据集',
    select_theme_datasets: '请选择主题数据集',
    default_datasets: '默认数据集',
    default_datasets_placeholder: '请选择默认数据集',
    welcome_text: '欢迎文案',
    welcome_text_placeholder: '请输入进入问数页时的欢迎提示',
    recommended_questions_placeholder: '一行一个推荐问题',
    default_dashboard_id: '默认仪表盘 ID',
    default_dashboard_id_placeholder: '可选，用于仪表盘问数默认绑定',
    delete_theme_confirm: '确认删除分析主题「{name}」吗？',
    ai_model_config: 'AI 模型配置',
    ai_model_config_desc: '统一管理 StarBI 智能问数使用的模型与默认能力。',
    term_config: '术语配置',
    term_config_desc: '维护业务术语和同义词，提升 StarBI 问数理解能力。',
    sql_example_config: 'SQL 示例库',
    sql_example_config_desc: '维护高质量 SQL 示例，增强 Text-to-SQL 生成效果。',
    ai_config_group: '通用配置',
    ...
    scheduled_reports_subtitle:
      '配置定时任务，自动发送仪表盘、电子表格等报告到邮箱、钉钉、企微、飞书。',
    query_config_resource_manage: '问数资源管理',
    query_config_theme_manage: '分析主题管理',
    adjust_theme_assignment: '调整分析主题分配',
    permission_probe_loading: '正在检查权限支持...',
    row_permission_config: '行权限配置',
    column_permission_config: '列权限配置',
    ai_config_current_module: '当前模块',
    ai_config_quick_entry: '快捷入口',
    ai_config_related_settings: '相关系统能力',
    ai_config_nav_title: '配置分组',
    ai_config_nav_desc: '同组配置在页面内切换，保持系统导航稳定、层级清晰。',
    ai_config_current_badge: '当前',
    ai_config_switch_badge: '切换',
    ai_config_embed_title: '嵌入式 AI 配置',
    ai_config_hosted_tip: '当前页面由 StarBI 系统管理承载，配置内容以内嵌 AI 模块方式提供。',
    ai_config_org_scope_tip: '配置会跟随当前组织切换，并继续受管理员权限控制。',
    ai_embed_unavailable: 'AI 配置页面暂不可用',
    ai_embed_connecting: '连接中',
    ai_embed_ready: '已连接',
    ai_embed_timeout: '连接超时',
    ai_embed_timeout_desc: 'AI 配置页面在预期时间内未完成加载，请刷新页面或重试连接。',
    ai_embed_loading_desc: '正在校验访问令牌并初始化嵌入页面，请稍候。',
    ai_embed_refresh: '刷新页面',
    ai_embed_retry: '重试连接',
    ai_embed_hosted_by_starbi: '由 StarBI 系统管理承载',
    ai_embed_service_domain: 'AI 服务：',
    ai_embed_last_ready: '最近同步：{0}',
    check_starbi_connection: '请检查 StarBI AI 服务接入配置、令牌与网络连通性',
    dashboard_query_entry: '问数',
    sqlbot_secret_placeholder: '请输入 StarBI Secret'
  },
  toolbox: {
    name: '工具箱',
  ...
  visualization: {
    ...
    app_name: '应用名称',
    app_version: '应用版本号',
    app_required_version: 'StarBI最低版本号',
    description: '描述',
    new_dataset: '新建数据集',
  ...
  report: {
    ...
    update_failed: '更新失败',
    load_failed: '加载失败',
    load_info_failed: '加载任务信息失败',
    load_logs_failed: '加载日志失败',
    load_error_failed: '加载错误详情失败',
    no_tasks: '暂无任务',
    no_logs: '暂无日志',
    no_error_message: '无错误信息',
    ...
    start_success: '任务已开始',
    stop_success: '任务已停止',
    start_confirm: '确定开始该任务？',
    stop_confirm: '确定停止该任务？',
    toggle_status_failed: '操作失败',
    fire_now: '立即执行',
    fire_now_confirm_title: '立即执行任务',
    fire_now_confirm_message: '确定立即执行该任务？',
    fire_now_success: '任务已发起执行',
    fire_now_failed: '执行失败',
    schedule: '发送频率',
    view_log: '查看日志',
    ...
    exec_time: '执行时间',
    exec_status: '执行状态',
    exec_status_filter: '状态筛选',
    recipient_count: '接收人数',
    error_detail: '错误详情',
    view_error: '查看错误',
    delete_logs: '删除日志',
    delete_logs_confirm: '确定删除所有日志？',
    delete_logs_success: '日志已删除',
    delete_logs_failed: '删除日志失败',
    step_basic: '基本信息',
    step_recipient: '接收人',
    step_send: '发送设置',
    report_type: '报告类型',
    report_type_required: '请选择报告类型',
    type_dashboard: '仪表板',
    type_spreadsheet: '电子表格',
    type_query: '数据查询',
    select_resource: '选择资源',
    select_resource_placeholder: '请选择资源',
    resource_required: '请选择资源',
    task_name: '任务名称',
    task_name_required: '请输入任务名称',
    task_name_placeholder: '请输入任务名称',
    task_name_length_limit: '任务名称长度不能超过100个字符',
    task_title: '报告主题',
    task_title_placeholder: '请输入报告主题',
    task_content: '报告正文',
    task_content_placeholder: '请输入报告正文',
    export_format: '导出格式',
    format_pdf: 'PDF',
    format_excel: 'Excel',
    format_image: '图片',
    ...
    webhook_url_placeholder: '请输入 Webhook URL',
    select_org_placeholder: '请选择用户',
    dingtalk: '钉钉',
    lark: '飞书',
    schedule_type: '发送频率',
    schedule_type_required: '请选择发送频率',
    type_hourly: '每小时',
    type_daily: '每天',
    type_weekly: '每周',
    type_monthly: '每月',
  ...
  userCenter: {
    ...
    api_key_desc:
      'API Key 是您访问 StarBI API 的密钥，具有账户的完全权限，请您务必妥善保管！不要以任何方式公开 API Key 到外部渠道，避免被他人利用造成安全威胁。'
  },
  free: {
    title: '游离资源管理',
    no_data: '暂无游离资源',
