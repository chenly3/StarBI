export default {
  common: {
    ...
    next_year: 'Next year',
    sqlbot_settings: 'StarBI AI Settings',
    sqlbot_old_settings: 'AI Query (OLD) Settings',
    third_party_embed: 'Third-party embed',
    application_id: 'Application ID',
    sqlbot_server_url: 'StarBI AI service URL',
  ...
  starbi: {
    brand_name: 'StarBI',
    smart_query_title: 'AI Query',
    smart_query_new_title: 'AI Query New',
    smart_query_old_title: 'AI Query (OLD)',
    smart_query_subtitle:
      'Choose an analysis theme and dataset scope in StarBI before starting a unified AI query session.',
    from_dashboard: 'From dashboard',
    dashboard_context_desc:
      'The current session already carries the dashboard context and filter conditions.',
    view_filter_snapshot: 'View filter snapshot',
    select_theme: 'Select analysis theme',
    select_theme_placeholder: 'Please select an analysis theme',
    select_datasets: 'Select dataset scope',
    select_datasets_placeholder: 'Please select datasets',
    select_datasource: 'Select execution datasource',
    select_datasource_placeholder: 'Please select a datasource',
    datasource_scope_hint:
      'Datasets in this theme span multiple datasources. Please choose the datasource for this session.',
    active_theme: 'Active theme',
    theme_not_selected: 'No theme selected',
    dataset_scope_count: 'Dataset count',
    current_datasource: 'Current datasource',
    datasource_not_selected: 'No datasource selected',
    auto_match: 'Auto match',
    selected_dataset_scope: 'Selected dataset scope',
    scope_dataset_progress: '{0} of {1} datasets selected',
    select_all_theme_datasets: 'Select all theme datasets',
    no_dataset_selected: 'No datasets selected for this scope',
    theme_description: 'Theme description',
    recommended_questions: 'Recommended questions',
    filter_count: '{0} filters applied',
    scope_will_restart:
      'The theme or dataset scope changed. Starting the query will create a new session.',
    default_query_desc:
      'Ask questions within the selected dataset scope, and the session will keep the current theme snapshot.',
    reset_scope: 'Reset scope',
    restart_query: 'Restart query',
    start_query: 'Start query',
    query_unavailable: 'StarBI AI query is unavailable',
    query_unavailable_desc:
      'Complete the StarBI service connection and validation in system settings first.',
    query_empty_title: 'Select an analysis theme to begin',
    query_empty_desc:
      'Choose a theme and dataset scope first, then enter the StarBI AI query session.',
    default_query_welcome: 'Hello, I am your StarBI AI analyst',
    dashboard_query_welcome:
      'I already have the current dashboard context and can continue querying within this analysis scene.',
    query_scope_invalid:
      'Please select an analysis theme, dataset scope, and datasource when required',
    query_theme_title: 'Analysis Themes',
    query_theme_subtitle:
      'Organize datasets by business scenario as the unified StarBI AI query scope entry.',
    new_query_theme: 'New analysis theme',
    theme_dataset_count: 'Datasets',
    enabled: 'Enabled',
    disabled: 'Disabled',
    no_query_theme: 'No analysis themes yet',
    query_theme_empty_title: 'No analysis themes are available yet',
    query_theme_empty_desc:
      'Create at least one analysis theme under Data Preparation and bind accessible datasets before returning to the StarBI AI query page.',
    go_create_query_theme: 'Create analysis theme',
    refresh_query_theme_list: 'Refresh theme list',
    edit_query_theme: 'Edit analysis theme',
    sort_order: 'Sort order',
    query_theme_description_placeholder: 'Describe the theme so users understand when to use it',
    theme_datasets: 'Theme datasets',
    select_theme_datasets: 'Please select theme datasets',
    default_datasets: 'Default datasets',
    default_datasets_placeholder: 'Please select default datasets',
    welcome_text: 'Welcome text',
    welcome_text_placeholder: 'Enter the welcome message shown before querying',
    recommended_questions_placeholder: 'One recommended question per line',
    default_dashboard_id: 'Default dashboard ID',
    default_dashboard_id_placeholder: 'Optional, used for dashboard query default binding',
    delete_theme_confirm: 'Delete analysis theme "{name}"?',
    ai_model_config: 'AI model settings',
    ai_model_config_desc: 'Manage the models and default capabilities used by StarBI AI query.',
    term_config: 'Terminology settings',
    term_config_desc: 'Maintain business terms and synonyms to improve StarBI query understanding.',
    sql_example_config: 'SQL example library',
    sql_example_config_desc:
      'Maintain high-quality SQL examples to improve Text-to-SQL generation.',
    ai_config_group: 'General settings',
    ai_config_center: 'AI settings center',
    ai_config_center_desc:
      'Maintain models, terminology, and SQL examples in one place as the common settings entry for AI query.',
    query_config_title: 'Query settings',
    query_config_subtitle:
      'Manage query resources and analysis themes together as the smart-query configuration entry under system settings.',
    query_config_resource_manage: 'Query resource management',
    query_config_theme_manage: 'Analysis theme management',
    adjust_theme_assignment: 'Adjust analysis theme assignment',
    permission_probe_loading: 'Checking permission support...',
    row_permission_config: 'Row permission settings',
    column_permission_config: 'Column permission settings',
    ai_config_current_module: 'Current module',
    ai_config_quick_entry: 'Quick entries',
    ai_config_related_settings: 'Related system settings',
    ai_config_nav_title: 'Configuration groups',
    ai_config_nav_desc:
      'Switch related settings inside the page so the system navigation remains stable and clear.',
    ai_config_current_badge: 'Current',
    ai_config_switch_badge: 'Open',
    ai_config_embed_title: 'Embedded AI settings',
    ai_config_hosted_tip:
      'This page is hosted by StarBI system management, while the configuration content is provided through the embedded AI module.',
    ai_config_org_scope_tip:
      'Configurations follow the current organization and remain protected by administrator permissions.',
    ai_embed_unavailable: 'The AI settings page is unavailable',
    ai_embed_connecting: 'Connecting',
    ai_embed_ready: 'Connected',
    ai_embed_timeout: 'Connection timed out',
    ai_embed_timeout_desc:
      'The AI settings page did not finish loading in time. Refresh the page or retry the connection.',
    ai_embed_loading_desc:
      'Validating the access token and initializing the embedded page. Please wait.',
    ai_embed_refresh: 'Refresh page',
    ai_embed_retry: 'Retry connection',
    ai_embed_hosted_by_starbi: 'Hosted by StarBI system management',
    ai_embed_service_domain: 'AI service:',
    ai_embed_last_ready: 'Last synced: {0}',
    check_starbi_connection:
      'Please check the StarBI AI service connection, token, and network availability',
    dashboard_query_entry: 'Ask',
    sqlbot_secret_placeholder: 'Please enter the StarBI Secret'
  },
  toolbox: {
    name: 'Toolbox',
  ...
  operate_log: {
    ...
    excel_file_name: 'StarBI operation log',
  ...
  commons: {
    ...
    weeks_5: 'Friday',
    weeks_6: 'Saturday',
    system_parameter_setting: 'System Settings',
  ...
  visualization: {
    ...
    app_required_version: 'Minimum StarBI Version',
    description: 'Description',
  ...
  userCenter: {
    ...
    api_key_desc:
      'API Key is your key to access the StarBI API, which has full permissions for your account. Please keep it safe! Do not disclose API Key to external channels in any way to avoid security threats caused by others. '
  },
  free: {
