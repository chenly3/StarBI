...
export const listDatasourceTables = async (data = {}, silentError = false): Promise<IResponse> => {
  return request.post({ url: '/datasource/getTables', data, silentError }).then(res => {
    return res
  })
}
...
export const previewData = (data = {}, silentError = false) => {
  return request.post({ url: '/datasource/previewData', data, silentError }).then(res => {
    return res?.data
  })
}
...
export const uploadFile = async (data): Promise<IResponse> => {
  return uploadFileWithOption(data, false)
}

export const uploadFileWithOption = async (data, silentError = false): Promise<IResponse> => {
  return request
    .post({
