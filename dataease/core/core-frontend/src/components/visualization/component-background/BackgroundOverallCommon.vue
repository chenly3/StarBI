...
const buildDefaultInnerPadding = () => ({
...
const buildDefaultBorderRadius = () => ({
  mode: ShorthandMode.Uniform,
  topLeft: 0,
  topRight: 0,
  bottomLeft: 0,
...
const normalizeInnerPadding = innerPadding => {
...
const normalizeBorderRadius = borderRadius => {
  ...
  return {
    ...buildDefaultBorderRadius(),
    ...(borderRadius || {})
  }
}

const buildDefaultCommonBackground = () => ({
  innerPadding: buildDefaultInnerPadding(),
...
const init = () => {
  const source = deepCopy(props.commonBackgroundPop || {})
  const commonBackgroundPop = {
    ...buildDefaultCommonBackground(),
    ...source,
    innerPadding: normalizeInnerPadding(source.innerPadding),
