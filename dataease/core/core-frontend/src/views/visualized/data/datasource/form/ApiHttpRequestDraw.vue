...
type RuntimeApiConfiguration = ApiConfiguration & {
  fields: Field[]
}

type PluginFormInstance = FormInstance & {
  invokeMethod?: (params: { methodName: string; args: any[] }) => void
}
...
let apiItemList = reactive<RuntimeApiConfiguration[]>([])
let paramsList = reactive<RuntimeApiConfiguration[]>([])
...
const xpackApiItemBasicInfo = ref<PluginFormInstance>()
