...
.filter-icon-span {
  border: 1px solid rgba(165, 196, 245, 0.92);
  width: 32px;
  height: 32px;
  border-radius: 10px;
  color: #2c4f80;
...
.resource-tree {
  ...
  border-right: 1px solid rgba(190, 217, 255, 0.82);
...
:deep(.search-bar .ed-input__wrapper),
:deep(.search-bar .el-input__wrapper) {
  border-radius: 12px;
  background: rgba(255, 255, 255, 0.96);
  box-shadow: inset 0 0 0 1px rgba(179, 208, 247, 0.94), 0 4px 14px rgba(29, 78, 216, 0.06);
}

:deep(.search-bar .ed-input__inner),
:deep(.search-bar .el-input__inner) {
  color: #244870;
}

:deep(.search-bar .ed-input__inner::placeholder),
...
:deep(.custom-tree .ed-tree-node__content),
...
:deep(.custom-tree .ed-tree-node__content:hover),
:deep(.custom-tree .el-tree-node__content:hover) {
  background: rgba(230, 240, 255, 0.9);
}

:deep(.custom-tree .ed-tree-node.is-current > .ed-tree-node__content),
:deep(.custom-tree .el-tree-node.is-current > .el-tree-node__content) {
  background: linear-gradient(180deg, rgba(214, 230, 255, 0.92), rgba(228, 239, 255, 0.94));
  box-shadow: inset 0 0 0 1px rgba(96, 149, 255, 0.24);
}
</style>

<style lang="less">
.menu-outer-dv_popper {
  --ed-border-color-light: rgba(186, 215, 255, 0.92);
  min-width: 140px;
