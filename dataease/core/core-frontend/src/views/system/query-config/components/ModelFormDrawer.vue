...
import ParamsForm from './ParamsFormDrawer.vue'
import { base_model_options, get_supplier, modelTypeOptions } from '@/utils/sqlbot-entity'
...
const baseModelChange = (val: string) => {
  ...
  nextTick(() => {
    modelRef.value?.clearValidate(['base_model', 'api_domain'])
  })
