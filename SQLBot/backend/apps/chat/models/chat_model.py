...
class ChatSessionSnapshot(SQLModel, table=True):
    ...
    active_source_kind: str = Field(sa_column=Column(String(32), nullable=False))
    active_source_id: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
    active_source_ids: Optional[list[str]] = Field(sa_column=Column(JSONB, nullable=True), default=None)
    active_combination_id: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
    active_combination_name: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
...
class ChatSessionEvent(SQLModel, table=True):
    ...
    source_kind: Optional[str] = Field(sa_column=Column(String(32), nullable=True))
    source_id: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
    source_ids: Optional[list[str]] = Field(sa_column=Column(JSONB, nullable=True), default=None)
    combination_id: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
    combination_name: Optional[str] = Field(sa_column=Column(String(255), nullable=True))
