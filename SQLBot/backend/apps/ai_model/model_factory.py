...
async def build_llm_config(db_model: AiModelDetail) -> LLMConfig:
    additional_params = {}
    if db_model.config:
        try:
...
async def get_model_config(model_id: Optional[int] = None, model_name: Optional[str] = None) -> LLMConfig:
    with Session(engine) as session:
        ...
        return await build_llm_config(db_model)
