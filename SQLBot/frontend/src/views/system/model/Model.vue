...
import { isStarBIPageMode } from '@/utils/utils'
...
const isStarBIEmbedded = computed(() => isStarBIPageMode(route.query.pageMode))
...
const showSearchEmpty = computed(
  () => hasSearchKeyword.value && !hasModelResults.value && !searchLoading.value
)
